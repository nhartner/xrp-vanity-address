...
import io.nhartner.xrp.vanity.addresses.exceptions.DecodeException;
import io.nhartner.xrp.vanity.addresses.exceptions.EncodeException;
import io.nhartner.xrp.vanity.addresses.exceptions.EncodingFormatException;
...
public class AddressCodec {
  ...
  private static final io.nhartner.xrp.vanity.addresses.AddressCodec INSTANCE = new io.nhartner.xrp.vanity.addresses.AddressCodec();

  public static io.nhartner.xrp.vanity.addresses.AddressCodec getInstance() {
    return INSTANCE;
  }
